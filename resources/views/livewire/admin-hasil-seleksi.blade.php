<div class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">Periode Aktif: {{ $periode ? $periode->nama_periode : 'Tidak ada periode aktif' }}</p>
        </div>
        
        <div>
            <button wire:click="hitungSAW" wire:loading.attr="disabled" class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg shadow-md transition flex items-center gap-2 focus:ring-4 focus:ring-indigo-300 dark:focus:ring-indigo-800">
    ...
    @if (session()->has('message'))
        <div class="p-4 mb-4 text-sm text-green-800 bg-green-100 rounded-lg dark:bg-green-900 dark:text-green-100 font-medium">
            ✅ {{ session('message') }}
        </div>
    @endif
            ...
            <tbody>
                @forelse ($hasilSeleksi as $hasil)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                        <td class="px-6 py-4 text-center font-extrabold text-lg 
                        ...
                        <td class="px-6 py-4 text-center font-mono font-bold text-blue-600 dark:text-blue-400 text-base">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                            <svg class="mx-auto h-12 w-12 text-gray-400 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
